...
@onready var character: CharacterMovementController = $CharacterMovementController
...
func _physics_process(delta):
	...
	var input = Vector2(
		round(Input.get_axis("move_left","move_right")),
		round(Input.get_axis("move_up","move_down"))
	)
