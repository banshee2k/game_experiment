...
## Character Speed
@export var Speed:float = 2. * scaling * 1.5;
...
@export var Gravity:float = .3 * scaling;
...
@export var GravityMaximum:float = 4.75  * scaling * 2;
# GravityScale
@export var GravityScale:float = 1.;
@export_group("On Air Variables")
## acceleration value in air
@export var AirAcceleration:float = 0.2  * scaling;
...
@export var Wall_Gravity:float = .1 * 1000.; 
## maximum gravity when doing a wall slide
@export var Wall_GravityMax:float = 1.75; 
## wall jump height
@export var Wall_JumpHeight:float = 3.5 * scaling * 1.5; 
## small wall jump jump value
@export var Wall_JumpHeightMin:float = 3 * scaling * 1.5; 
## how much to push the character during wall jumpo
@export var Wall_JumpOffset:float = 4 * scaling * 1.5; 
## character push value on small wall jumps
@export var Wall_JumpOffsetMin:float = 2 * scaling * 1.5; 
...
@export var Dash_Strength:float = 4 * scaling * 2;
...
@export var Dash_diag_scale:float = 1;
